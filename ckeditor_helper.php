...
/**
 * set_ckeditor function.
 * This function look for print script for id with customize options
 *
 * @author pavel <azc.pavel@gmail.com>
 * @access public
 * @param  String $id. (default: ckeditor ),String $width. (default: 550px ),String $height. (default: 100px ),String $option. (default: Full ),Array $skins (default: moono, ''), Array $toolbar 
 * @print  String
 */
function set_ckeditor($id = 'ckeditor', $width = '550px', $height = '100px', $option = 'Full', $skins = array('moono',''), $toolbar = array(array('Bold', 'Italic','Underline', 'Strike', 'FontSize','Font','Smiley')))
    {
    	/*****************For Skip Steps**********************/
    	if($id == '')
    		$id = 'ckeditor';
        ...
        $data =array(
                ...
                //Optionnal values
                'config' => array(
                    'toolbar'   =>  $option,    //Using the Full toolbar
                    'width'     =>  $width,     //Setting a default width
                    'height'    =>  $height,    //Setting a default height
                    'skin'		=>  $skins[0],	//Will set default if value empty
                    'uiColor' 	=>  $skins[1]	//Will set default if value empty
        ...
        $data =array(
                ...
                //Optionnal values
                'config' => array(
                    'toolbar'   =>  $toolbar,  //Using the Fixed toolbar each array will create new toolbar
